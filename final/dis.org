...
academia and /XXIIV/; an experimental personal archive. They both
...
*Projector*, represented in two classes ~ofApp~ and ~Projector~. The *GUI*
window is a control panel or the computer vision tracking. Controls for the
parameters are available in the *GUI* window as well handles to crop the active
region part of the camera frame were the computer vision happens. In the
...
display of on the reaction surface.

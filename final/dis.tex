...
\label{sec:orgff249a1}

\section{Project aims}
\label{sec:org6797ae6}
...
\section{Definitions}
\label{sec:orga9bb899}
\begin{enumerate}
\item Computing
\label{sec:org784941f}
\item keyboard-mouse-monitor model (kmm model) (?)
\label{sec:org1928579}
\item Cognition
\label{sec:org059152a}
\item Exocortex
\label{sec:orge7824b8}
\end{enumerate}

\section{Beginning with the Exocortex}
\label{sec:org81af19e}
